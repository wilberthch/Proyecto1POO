...
public class MenuMedidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel36.setText("Porcentaje Grasa Corporal");
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
        try{
            Paciente tempPaciente = pacientes.get(posPaciente);
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Este paciente ya no existe");
        return;
        }
        try{
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog(this, "No existen Medidas!");
            return;
        }
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        ...
        pacientes.get(posPaciente).getMedida().remove(numeroMedida);
        refreshMedidaTab();
        JOptionPane.showMessageDialog(this, "La medicion fue eliminada exitosamente");
